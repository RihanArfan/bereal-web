...
<template>
  ...
  >
    ...
    <input
      ...
      class="w-full border-t-2 border-zinc-800 bg-transparent px-3 py-3 placeholder:text-zinc-500 sm:rounded-lg sm:border-2 sm:bg-zinc-900"
